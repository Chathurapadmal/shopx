  ...
  return (
    <aside className="w-64 bg-slate-900 text-white flex flex-col h-screen fixed left-0 top-0">
      <div className="p-4 border-b border-slate-700">
        ...
        <div className="text-xs text-slate-500 mt-1 capitalize">{user.role.replace("_", " ")}</div>
      </div>
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="mb-2 px-3 py-2 text-sm text-slate-400 truncate">{user.email}</div>
        <button
          onClick={logout}
